        ...
        <div className="paying-attention-frontend">
            ...
            <ul>
                {props.answers.map(function(answer, index) {
                    return (
                        <li clasName={(isCorrectDelayed === true && index == props.correctAnswer ? "no-click" : "") + (isCorrectDelayed === true && index != props.correctAnswer ? "fade-incorrect" : "")} onClick={isCorrect === true ? undefined : () => handleAnswer(index)}>
            ...
            <div className={"correct-message" + (isCorrect == true ? " correct-message--visible" : "")}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" clasName="bi bi-emoji-smile" viewBox="0 0 16 16">
